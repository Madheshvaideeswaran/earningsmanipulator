...
# ---------------------------------------------------
# FULL YELLOW THEME (PROFESSIONAL)
# ---------------------------------------------------
st.markdown("""
<style>
...
.stApp {
    background-color: #fff4cc;  /* soft professional yellow */
    color: #1f2937;
}
...
st.markdown("""
This application uses **machine learning models** to identify potential  
**earnings manipulation** based on Beneish indicators.
...
if uploaded_file is not None:
    try:
        ...
        if run:
            ...
            st.markdown("---")
            st.subheader("Beneish M-Score Baseline (Reference)")
